...
def plot_results(predicted_data, true_data):
    ...
    plt.legend()
    plt.savefig("/home/cc/桌面/SFM/test/PNG/plot.png")
    plt.show()
...
if __name__=='__main__':
    ...
    model_path = '/home/cc/桌面/SFM/train/snapshot/weights12345.hdf5'
    # f = h5py.File(model_path, 'r')
    # print(f.keys())
    # print(type(f['itosfm_1']))
    # print(f['itosfm_1']['itosfm_1_U_a'].value)
    # print(f.attrs.keys())
    ...
    print ('MSE: %f' % error)
    error = np.sum(abs(prediction[:,-test_len:] - gt_test[:,-test_len:])) / (test_len* prediction.shape[0])
    print ('MAE: %f' % error )
